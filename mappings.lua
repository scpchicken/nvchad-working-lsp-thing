...
M.telescope = {
  ...
  n = {
    ...
    ["gd"] = {"<cmd> lua vim.lsp.buf.definition() <CR>", "lsp def"},
    ["<leader>ra"] = { "<cmd> lua require('nvchad_ui.renamer').open() <CR>", "lsp rename" },
     ...
     ["gr"] = { "<cmd> lua vim.lsp.buf.references()<CR>", "lsp reference"},
